function animarNumero(element, valorFinal, duracao = 1000, prefixo = "", casasDecimais = 2) {
    let inicio = 0;
...
document.addEventListener("DOMContentLoaded", async () => {
    const response = await fetch("https://localhost:8800/sure/stats");
    ...
    animarNumero(document.getElementById("stake"), data.stakeTotal, 1000, "R$ ", 2);    // 2 casas decimais
});